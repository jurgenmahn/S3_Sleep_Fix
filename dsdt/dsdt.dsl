 ...
 *
 * Disassembly of dsdt.aml, Fri Jan 31 01:02:11 2025
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000162D1 (90833)
 *     Revision         0x02
 *     Checksum         0x2F
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "88D0    "
...
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "88D0    ", 0x01072010)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB59B8000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB59BC000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB712FF18)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB712FD98, 0x10)
    ...
    OperationRegion (EXBU, SystemMemory, 0xB7134018, 0x1008)
    ...
    Scope (_SB.WMID)
    {
        OperationRegion (MPBS, SystemMemory, 0xFF436000, 0x08)
        ...
        Device (RHUB)
        {
            ...
            Device (PRT6)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x01, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,  // ..r.....
                        /* 0008 */  0x71, 0x0C, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,  // q.......
                        /* 0010 */  0xFF, 0xFF, 0xFF, 0xFF                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
        ...
        Device (RHUB)
        {
            ...
            Device (PRT6)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x01, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,  // ..r.....
                        /* 0008 */  0x71, 0x8C, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,  // q.......
                        /* 0010 */  0xFF, 0xFF, 0xFF, 0xFF                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
    ...
    Scope (_SB.I2CA)
    {
        ...
        Device (TPL1)
        {
            Name (_HID, "GTCH7503")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, 0x03)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
    ...
    Scope (_SB.I2CD)
    {
        ...
        {
            Name (_ADR, One)  // _ADR: Address
            Name (_HID, "SYNA32AA")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, One)  // _UID: Unique ID
            Name (_S0W, 0x04)  // _S0W: S0 Device Wake State
            Name (RBUF, ResourceTemplate ()
        ...
        {
            Name (_ADR, One)  // _ADR: Address
            Name (_HID, "ELAN072C")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, One)  // _UID: Unique ID
            Name (_S0W, 0x04)  // _S0W: S0 Device Wake State
            Name (RBUF, ResourceTemplate ()
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Return (RBUF) /* \_SB_.I2CD.TPD1.RBUF */
            }
        ...
        Scope (GPP2)
        {
            ...
            Device (DEV0)
            {
                ...
                PowerResource (PWRE, 0x00, 0x0000)
                {
                    Method (_STA, 0, NotSerialized)  // _STA: Status
                    {
                        Return (PSTA) /* \_SB_.PCI0.GPP2.DEV0.PSTA */
                    }
